...
public class CustomerRepositoryImpl implements CustomerRepository {
	...
	public CustomerEntity findOne(long id) {
		...
		customer.setId(id);
		customer.setName("롱롱비");
		customer.setAddress("경기도");
		customer.setEmail("qwer@naver.com");
		return customer;
	}
	...
	public List<CustomerEntity> findAll() {
		...
		for(int i = 0; i < 10; ++i) {
			CustomerEntity customer = new CustomerEntity();
			customer.setId(i);
			customer.setName("롱비"+i);
			customer.setAddress("서울"+i);
			customer.setEmail("rong"+i+"@gmail.com");
	...
	public List<CustomerEntity> findAll(Pageable page) {
		...
		for(int i = index; i < index+size; ++i) {
			CustomerEntity customer = new CustomerEntity();
			customer.setId(i);
			customer.setName("롱비비"+i);
			customer.setAddress("서울시"+i);
			customer.setEmail("rrong"+i+"@gmail.com");
			customers.add(customer);
		}
		return customers;
	}
